...
class Model:
    ...
    def getNCreatedNodes(self) -> int: ...
    def getNCreatedNodesRun(self) -> int: ...
    def getNumLPBranchCands(self) -> int: ...
    def relPosition(self, node_bound: float, ub: float, lb: float) -> float: ...
    def relDistance(self, x: float, y: float) -> float: ...
    def gNormMax(self, x: float) -> float: ...
    def getVarScore(self, varscore: float, avgscore: float) -> float: ...
    def getFairNNodes(self, brancher_name: str) -> int: ...
    def getNodeState(self, node_dim: int) -> np.ndarray: ...
    def getMIPState(self, mip_dim: int) -> np.ndarray: ...
    def getCandsState(self, var_dim: int, branch_count: int) -> tuple[list[Variable], list[int], np.ndarray]: ...
    def executeBranchRule(self, name: str, allowaddcons: bool) -> int: ...
    @staticmethod
